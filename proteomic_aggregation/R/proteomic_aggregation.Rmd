...
gff_extract_features <- function(url) { paste("Placeholder for reading gff from", url) }
...
spec_filt_value <- function(specprob, forward_peptides, reversed_peptides) {
    ...
    # df_r = reversed_peptides[ (reversed_peptides["MSGFDB_SpecEValue"] < 10 ** specprob) ].copy()
    # df_f = forward_peptides[ (forward_peptides["MSGFDB_SpecEValue"] < 10 ** specprob) ].copy()
...
get_razor_protein <- function(annot_df){
