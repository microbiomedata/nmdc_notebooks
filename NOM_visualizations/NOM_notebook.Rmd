...
samples_for_heatmap <- processed_data_qc %>%
  ...
  left_join(select(nom_objects_joined_labeled, dobj.url, bsm.id, bsm.sample_type_manual, bsm.part_of, bsm.lat_lon.latitude, bsm.lat_lon.longitude), 
...
heatmaply(holder, Colv = NA, RowSideColors = cbind(study_color_vec, sample_type_color_vec, latitude_color_vec), showticklabels = FALSE, hide_colorbar = TRUE)
